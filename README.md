<h1>API Management Developer Portal</h1>

<p>This repository contains the components necessary to create a developer portal for Forum Systems API Management 
using the Drupal content management system.</p>

<p><code>fs_apim</code> = a drupal module containing the Forum Systems API Management integration<br/>
<code>fs_theme</code> = a configurable drupal theme<br/>
<code>fs_taxonomy_menu_block</code> = a block to browse a hierarchical taxonomy<br/>
...
<code>fs_profile</code> = a drupal installation profile to create a dev portal zip containing everything you need.</p>
...
javascript libraries and theme) can be downloaded from the <a href="https://github.com/fsuser1/devportal/releases/latest">Latest Release</a> page.</p>
...
<ul><li>default is the same as API Management</li>
...
<h3>Forum Systems API Management Integration</h3>
<ul><li>Self-signup from the drupal portal</li>
<li>Users already known to API Management can simply login, no need to create another account (one is created automatically)</li>
...
<li>Can only access items in the drupal DB if can access the equivalent in API Management</li>
...
<li>See API Management notification messages</li></ul>
...
<h2>Requirements</h2>
<p>You will require Forum Sentry v9.x to use this code.</p>
