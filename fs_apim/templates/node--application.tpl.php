...
drupal_add_js(drupal_get_path('module', 'fs_apim') . '/js/App.js', array(
  'weight' => 3
));
?>
<article id="node-<?php print $node->nid; ?>"
  ...
  <div class="mesh-portal-product">
    <div class="application">
      ...
      <?php $showplaceholders = variable_get('fs_apim_show_placeholder_images', 1); ?>
      <?php $applifecycle_enabled = variable_get('fs_apim_applifecycle_enabled', 0); ?>
      ...
      <div class="appTitleBar"><h1 class="appTitle"><?php print $title; ?></h1>
        ...
        <div
          ...
          <?php $analytics_enabled = variable_get('fs_apim_show_analytics', 1);
          $fs_apim_social_login = variable_get('fs_apim_social_login', 0);
          $pdur_analytics_enabled = variable_get('fs_apim_pdur_analytics', 0);
          if ($analytics_enabled == 1 && ($fs_apim_social_login == 0 || $pdur_analytics_enabled == 1)) :?>
                    ...
                    <div class="field-items">
                      <figure class="clearfix field-item even">
                        <img typeof="foaf:Image" class="image-style-none"
                             src="<?php print file_create_url(drupal_get_path('module', 'fs_apim') . '/images/icons/app/' . application_random_image($node->title)); ?>"
                      ...
                      <div class="credentialInfo">
                        ...
                        <div id="app_client_id" class="app_client_id">
                          ...
                          <div class="passwordToggleContainer">
                            ...
                            <?php $fs_apim_allow_clientidreset = variable_get('fs_apim_allow_clientidreset', TRUE); ?>
                            <?php if ($fs_apim_allow_clientidreset == 1): ?>
                            &nbsp;&nbsp;&nbsp;&nbsp; <a class="buttonLink"
                        ...
                        <div class="client_secret">
                          ...
                          <?php $fs_apim_allow_clientsecretreset = variable_get('fs_apim_allow_clientsecretreset', TRUE); ?>
                          <?php if ($fs_apim_allow_clientsecretreset == 1): ?>
                          <a class="buttonLink"
            ...
            <div class="subscriptionsWrapper">
              <?php if (is_array($subscriptions) && count($subscriptions) > 0) : ?>
                <?php foreach ($subscriptions as $plankey => $sub) : ?>
                  ...
                  $showversion = variable_get('fs_apim_show_versions', 1);
                  $versiontext = '';
                  if ($showversion == 1) {
                  ...
                  <div class='planWrapper'>
                    ...
                    <?php if (isset($sub['superseded-by']) && !empty($sub['superseded-by']) && isset($isdev) && $isdev == TRUE) : ?>
                      ...
                      <div class='migratePlanContainer'>
                        <div
                          class='migrateButton'><?php print l(t('Migrate'), 'application/' . $application_apiid[0]['safe_value'] . '/migrate/' . $sub['subid'] . '/' . fs_apim_base64_url_encode($sub['superseded-by'])); ?></div><div
