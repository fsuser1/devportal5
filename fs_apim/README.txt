...
fs_apim.module documentation
=============================

This module provides Forum Systems API Management Developer portal functionality
to Drupal.

After installing this module you will need to provide the information to connect
to the Forum Systems API Management platform.  The configuration page will be at
/admin/config/system/fs_apim.
