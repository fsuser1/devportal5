 ...
 * @param $vars
 */
function fs_theme_preprocess_html(&$vars) {
  global $theme_key;
 ...
 * @param $vars
 */
function fs_theme_process_html(&$vars) {
 ...
 * @param $hook
 */
function fs_theme_preprocess_page(&$vars, $hook) {
 ...
 * @param $vars
 */
function fs_theme_process_page(&$vars) {
  // Hook into the color module.
  if (module_exists('color')) {
 ...
 * @param $vars
 */
function fs_theme_preprocess_block(&$vars) {
 ...
 * @param $vars
 */
function fs_theme_preprocess_node(&$vars) {
 ...
 * @param $vars
 */
function fs_theme_preprocess_comment(&$vars) {
  // Add class if user picture exists
  if ($vars['picture']) {
 ...
 * @param $vars
 */
function fs_theme_process_region(&$vars) {
 ...
 * @param $items
 */
function fs_theme_menu_alter(&$items) {
  $items['user']['title callback'] = 'fs_theme_user_menu_title';
}

/**
 * @return null|string
 */
function fs_theme_user_menu_title() {
  global $user;
 ...
 * @return string
 */
function fs_theme_menu_tree__user_menu(&$variables) {
  global $user;
 ...
 * @ingroup themeable
 */
function fs_theme_node_add_list($content) {
  $output = '';
 ...
 * @param $vars
 */
function fs_theme_preprocess_username(&$vars) {
