...
fs_theme is a minimal, re-colorable, multi-column theme which uses HTML5
and includes many advanced theme settings to allow you to customize 
the theme to your requirements.
It has been styled to match Forum Systems API Management but can be easily customised to suit your own needs.


-- REQUIREMENTS --

fs_theme 7.x-2.x is a sub-theme of Adaptivetheme, you must download and install
...
* Theme settings and layout: fs_theme includes lots of theme settings including
  the ability to change the layout and support for mobile devices. Visit the
  theme settings page admin/appearance/settings/fs_theme to configure your settings.
...
* Color options: Enable the theme at admin/appearance, and visit
  admin/appearance/settings/fs_theme to modify the color scheme if desired.

* Menus: The fs_theme theme does not support the hard coded menu defaults. To setup
...
fs_theme supports the Superfish module which is a dynamic menu module and enables
...
-- HISTORY --
This theme is based on the Sky theme by Jeff Burnz & Jacine Luisi:
