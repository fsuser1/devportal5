 ...
 */
function hook_fs_taxonomy_menu_block_tree_alter(&$tree, $config) {
 ...
 */
function hook_fs_taxonomy_menu_block_alter(&$tree, $vid) {
 ...
 */
function hook_fs_taxonomy_menu_block_active_tid_alter(&$tid, &$config) {
